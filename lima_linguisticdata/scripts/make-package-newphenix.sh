...
$checkout linguisticData/syntacticAnalysis/rules-l2r-fre-homodeps.txt;
$checkout linguisticData/syntacticAnalysis/rules-l2r-fre-pleonasticPronouns.txt;
...
$checkout linguisticData/syntacticAnalysis/rules-r2l-fre-homodeps.txt;
$checkout linguisticData/syntacticAnalysis/rules-r2l-ger-homodeps.txt;
$checkout linguisticData/syntacticAnalysis/rules-r2l-pass1-fre-homodeps.txt;
