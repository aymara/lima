...
Ubuntu 16.04 , Semaphore-ci Build Status: [![Semaphore-ci Build Status](https://semaphoreci.com/api/v1/kleag/lima/branches/master/badge.svg)](https://semaphoreci.com/kleag/lima)

Ubuntu 14.04 , Travis-ci Build Status: [![Travis-ci Build Status](https://travis-ci.org/aymara/lima.svg?branch=master)](https://travis-ci.org/aymara/lima)
