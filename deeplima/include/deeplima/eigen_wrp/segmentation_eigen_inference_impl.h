...
class SEGM_EXPORT BiRnnEigenInferenceForSegmentation : public deeplima::eigen_impl::BiRnnInferenceBase
{
public:
  ...
  {
    auto p_op = std::dynamic_pointer_cast<deeplima::eigen_impl::Op_BiLSTM_Dense_ArgMax<Eigen::MatrixXf, Eigen::VectorXf, float>>(Parent::m_ops[0]);
