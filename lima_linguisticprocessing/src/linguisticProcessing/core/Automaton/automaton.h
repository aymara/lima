...
public:
 ...
 protected:
  ...
  class DFSStack;
  friend LIMA_AUTOMATON_EXPORT std::ostream& operator << (std::ostream& os, const DFSStack& x);
  friend LIMA_AUTOMATON_EXPORT QDebug& operator << (QDebug& os, const DFSStack& x);
