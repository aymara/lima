...

{
...
#ifdef ANTINNO_ASFALDA
  str_program_name = "c://python24//python.exe";
  wchar_t* pythonPath = L"c://python24//python.exe";
  //Py_SetProgramName(const_cast<wchar_t*>( str_program_name.toStdWString().c_str()));
  // Erreur de link que je pige pas, je triche...
  ...
  if (PyList_Append(pythonpath, PyUnicode_DecodeFSDefault("D:/telechargement Amose/knowledgesrl/src")) ==  -1)
  {
	   SEMANTICANALYSISLOGINIT;
