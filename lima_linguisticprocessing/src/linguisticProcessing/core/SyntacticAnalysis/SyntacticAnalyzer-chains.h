...
#ifndef SYNTACTICANALYZERCHAINS_H
#define SYNTACTICANALYZERCHAINS_H
...
#define SYNTACTICANALYZERCHAINS_CLASSID "SyntacticAnalyzerChains"
 ...
 */
class LIMA_SYNTACTICANALYSIS_EXPORT SyntacticAnalyzerChains : public MediaProcessUnit
{
public:
   ...
   */
  virtual ~SyntacticAnalyzerChains() {}
...
inline MediaId SyntacticAnalyzerChains::language() const
{
  return m_language;
}
