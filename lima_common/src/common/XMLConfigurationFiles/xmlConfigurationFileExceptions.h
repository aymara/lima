...
namespace Lima {
  namespace Common {
    namespace XMLConfigurationFiles
    {
      ...
      public:
        ...
        virtual const char* what() const throw() {return ( "No such module " + moduleName ).c_str();}
    private:
    ...
    public:
      ...
      //! @brief return the message error
      virtual const char* what() throw() {return ( "No such group " + groupName ).c_str();}
  private:
  ...
  public:
    ...
    //! @brief return the message error
    virtual const char* what() throw() {return ( "No such attribute " + attName ).c_str();}
private:
...
public:
  ...
  //! @brief return the message error
  virtual const char* what() throw() {return ( "No such param " + paramName ).c_str();}
private:
...
public:
  ...
  //! @brief return the message error
  virtual const char* what() throw() {return ( "No such list " + listName ).c_str();}
private:
...
public:
  ...
  //! @brief return the message error
  virtual const char* what() throw() {return ( "No such map " + mapName ).c_str();}
private:
