...
namespace Lima {
  namespace Common {
    namespace XMLConfigurationFiles
    {
      ...
      public:
        ...
        virtual const char* what() const {return ( "No such module " + moduleName );}
    private:
    ...
    public:
      ...
      //! @brief return the message error
      virtual const char* what() {return ( "No such group " + groupName );}
  private:
  ...
  public:
    ...
    //! @brief return the message error
    virtual const char* what() {return ( "No such attribute " + attName );}
private:
...
public:
  ...
  //! @brief return the message error
  virtual const char* what() {return ( "No such param " + paramName );}
private:
...
public:
  ...
  //! @brief return the message error
  virtual const char* what() {return ( "No such list " + listName );}
private:
