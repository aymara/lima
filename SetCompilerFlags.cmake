...
if (${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    ...
    if (WITH_ASAN)
      ...
      if (HAVE_SANITIZE_ADDRESS)
        ...
        set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -fsanitize=address -fno-sanitize-recover=all -fsanitize=float-divide-by-zero -fsanitize=float-cast-overflow -fno-sanitize=null -fno-sanitize=alignment -O1")
