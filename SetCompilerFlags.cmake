...
if (${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    ...
    if (WITH_ASAN)
      ...
      if (HAVE_SANITIZE_ADDRESS)
        message("Compiling with -fsanitize=address")
        set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -fsanitize=address -fno-sanitize-recover=all -fsanitize=float-divide-by-zero -fsanitize=float-cast-overflow -fno-sanitize=null -fno-sanitize=alignment -O1 -g")
        set(CMAKE_SHARED_LINKER_FLAGS_DEBUG "${CMAKE_SHARED_LINKER_FLAGS_DEBUG} -fsanitize=address")
        set(CMAKE_MODULE_LINKER_FLAGS_DEBUG "${CMAKE_MODULE_LINKER_FLAGS_DEBUG} -fsanitize=address")
        set(CMAKE_EXE_LINKER_FLAGS_DEBUG "${CMAKE_MODULE_LINKER_FLAGS_DEBUG} -fsanitize=address")
      else()
        message(FATAL_ERROR "ASAN required but -fsanitize=address is not supported")
      endif()
      CHECK_CXX_COMPILER_FLAG(-fsanitize=undefined HAVE_SANITIZE_UNDEFINED)
      if (HAVE_SANITIZE_UNDEFINED)
        message("Compiling with -fsanitize=undefined")
        ...
        message(FATAL_ERROR "ASAN required but -fsanitize=undefined is not supported")
      endif()
      ...
      if (HAVE_SANITIZE_LEAK)
        ...
        message(FATAL_ERROR "ASAN required but -fsanitize=leak is not supported")
      endif()
      ...
      if (HAVE_SANITIZE_THREAD)
        ...
        message(AUTHOR_WARNING "ASAN required but -fsanitize=thread is not supported")
      endif()
...
#    set(CMAKE_MODULE_LINKER_FLAGS "-Wl,--no-as-needed")
    ...
    if (WITH_ASAN)
      ...
      if (HAVE_SANITIZE_ADDRESS)
        ...
        message(FATAL_ERROR "ASAN is required but -fsanitize=address is not available")
      endif()
      CHECK_CXX_COMPILER_FLAG(-fsanitize=undefined HAVE_SANITIZE_UNDEFINED)
      if (HAVE_SANITIZE_UNDEFINED)
        set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -fsanitize=undefined")
        ...
        message(FATAL_ERROR "ASAN is required but -fsanitize=undefined is not available")
      endif()
      CHECK_CXX_COMPILER_FLAG(-fsanitize=leak HAVE_SANITIZE_LEAK)
      if (HAVE_SANITIZE_LEAK)
        set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -fsanitize=leak")
        ...
        message(FATAL_ERROR "ASAN is required but -fsanitize=leak is not available")
      endif()
